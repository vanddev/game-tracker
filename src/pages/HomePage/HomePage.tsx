...
function HomePage() {
    ...
    const recentlyAddedData = [
        { name: "God of War", image: "/similar_games/godofwar.png", genres: ["Adventure"], ggstatus: 'finished' },
        { name: "Remnant: From the Ashes", image: "/similar_games/remnant.jpg", genres: ["Action"], ggstatus: 'finished' },
        { name: "Dragon: Marked for Death", image: "/similar_games/dragonmarketfordeath.png", genres: ["Role-playing (RPG)"], ggstatus: 'dropped' },
        { name: "Borderlands 3", image: "/similar_games/borderlands3.png", genres: ["Shooter"], ggstatus: 'wishlist' },
        { name: "Life is Feudal: Your Own", image: "/similar_games/lifeisfeudal.jpg", genres: ["Role-playing (RPG)"], ggstatus: 'finished' },
        { name: "Pokemon Shield", image: "/similar_games/pokemonshield.png", genres: ["Role-playing (RPG)"], ggstatus: 'finished' },
    ]
    ...
    return (
        <>           
            <div className='stats'>
                <StatsCard title="Total Games" stats="19" iconPath={mdiControllerClassic}></StatsCard>
                ...
                <StatsCard title="Estimated Play Time" stats="298 hrs" iconPath={mdiClock}></StatsCard>    
            </div>
            <Section title="Recently Added" removeBackground>
                <div className='cards'>
                    {recentlyAddedData.map((game, index) => (
                        <GameCard key={index} name={game.name} cover={game.image} genres={game.genres} ggstatus={game.ggstatus}></GameCard>
                    ))}
                </div>
            </Section>
